...
const GlidingCard = ({ frontContent, backContent }) => {
  const [
...
<div className='ml-8 mb-5'>
    ...
    <Image src={'/neo1.png'} alt=' ' width={400} height={100}/>
...
{frontContent}
  ...
  >
    <Image src={'/neo.png'} alt='' width={400}  height={100} quality={100}/>
    {backContent}
  </div>
</div>
);
